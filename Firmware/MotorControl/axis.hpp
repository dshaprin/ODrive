...
public:
    ...
    struct CANConfig_t {
        ...
        uint32_t command_counter_rate_ms = 0;
    };
    ...
    struct CAN_t {
        ...
        uint32_t last_command_counter_increment = 0;
    ...
    SineAccelerationTrajectory& sin_accl_traj_;
